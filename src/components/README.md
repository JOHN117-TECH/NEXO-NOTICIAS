...
Los estilos específicos se encuentran en `styles/components/<Componente>.module.css` y se importan mediante `@/styles/components/<Componente>.module.css`. Los formularios y controles que comparten apariencia utilizan los módulos de `styles/components/ui/`. Los ajustes responsive permanecen en el módulo CSS correspondiente.
